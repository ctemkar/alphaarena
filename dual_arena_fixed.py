...
<html>
<head>
    <title>Alpha Arena | Dual View</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <style>
        body { background:#0b0e11; color:#fff; font-family:-apple-system, sans-serif; padding:15px; margin:0; overflow-x:hidden; }
        .section { background:#181a20; border:1px solid #2b2f36; border-radius:10px; padding:15px; margin-bottom:15px; display:flex; flex-direction:column; }
        .grid { display:flex; gap:15px; width:100%; flex-wrap:nowrap; align-items:flex-start; }
        ...
        h3 { margin: 0 0 10px 0; font-size: 14px; letter-spacing: 1px; color: #848e9c; }
