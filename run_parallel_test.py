...
VARIANTS = [
    {
        "name": "VARIANT-A (edge=0.055 tight size=15)",
        "port": 8001,
        "model": "Llama-3.2",
        "edge": 0.055,
        "persistence": 1,
    ...
    {
        "name": "VARIANT-B (edge=0.055 tight size=25)",
        "port": 8002,
        "model": "Llama-3.2",
        "edge": 0.055,
        "persistence": 1,
    ...
    {
        "name": "VARIANT-C (edge=0.065 ultra-tight size=15)",
        "port": 8003,
        "model": "Llama-3.2",
        "edge": 0.065,
        "persistence": 1,
...
def start_server(v: dict) -> subprocess.Popen:
    ...
    env.update({
        ...
        "ALPHA_MOMENTUM_OVERRIDE_THRESHOLD_PCT_BASKET": str(v["edge"]),
