...
VARIANTS = [
    {
        "name": "VARIANT-V1 (det_mom move=0.010 p=1 rev=1.6 size=150)",
        "port": 8001,
        "model": "Llama-3.2",
        "edge": 0.010,
        "persistence": 1,
    ...
    {
        "name": "VARIANT-V2 (det_mom move=0.020 p=1 rev=1.6 size=150)",
        "port": 8002,
        "model": "Llama-3.2",
        "edge": 0.020,
        "persistence": 1,
    ...
    {
        "name": "VARIANT-V3 (det_mom move=0.030 p=1 rev=1.6 size=150)",
        "port": 8003,
        "model": "Llama-3.2",
        "edge": 0.030,
        "persistence": 1,
